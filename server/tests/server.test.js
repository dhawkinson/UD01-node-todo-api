...
describe('GET /todos/:id', () => {
    ...
    it('should return status 404 for invalid ObjectID', (done) => {
        request(app)
            .get('/todos/123abc')
            .set('x-auth', users[0].tokens[0].token)
            .expect(404)
...
describe('DELETE /todos/:id', () => {
    ...
    it('should return 404 if ObjectID in not valid', (done) => {
        request(app)
            .delete('/todos/123abc')
            .set('x-auth', users[1].tokens[0].token)
            .expect(404)
...
describe('PATCH /todos/:id', () => {
    ...
    it('should not update the todo when created by another user', (done) => {
        let hexId = todos[0]._id.toHexString();
        let text  = 'This is more new text';
    ...
    it('should clear completedAt when todo is not completed', (done) => {
        let hexId = todos[1]._id.toHexString();
        let text  = 'This is also the new text';
        request(app)
        .patch(`/todos/${hexId}`)
        .set('x-auth', users[1].tokens[0].token)
        .send({
